...
var doValidateName = (event) => {
    ...
    document.querySelector("#nameErr").innerHTML = "Only caps without any special characters"
    return false
}

var doValidateAge = (event) => {
    x = event.charCode;
    ...
    document.querySelector("#ageErr").innerHTML = "Only numbers without any special characters"
    return false
}

var doValidateMarks = (event) => {
    x = event.charCode;
    var data = [];
    data.marks = document.querySelector("#mathsMarks").value;

    if (x >= 48 && x <= 57) {

        return true;
    }
    document.querySelector("#marksErr").innerHTML = "Only numbers without any special characters"
    return false
